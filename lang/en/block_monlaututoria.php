...
$string['monlaututoria:addinstance'] = 'Add a new Monlau Tutoria block';
$string['monlaututoria:myaddinstance'] = 'Add a new Monlau Tutoria block to the Dashboard';

$string['block_unavailable'] = 'You do not have access to the tutoring screens.';
...
$string['block_open_referrals'] = 'Open referrals';
$string['block_open_coordination'] = 'Open coordination dashboard';
$string['block_open_coordination_scopes'] = 'Manage coordinators and cohorts';
